...
namespace Lab2
{
    public partial class InternshipsApply : System.Web.UI.Page
    {
        ...
        protected void btnAssign_Click(object sender, EventArgs e)
        {
            ...
            lblStatus.Text = "Applied to internship! ";
            ...
            String sqlQuery = "INSERT INTO InternshipApplications (StudentID,InternshipID) VALUES ('" + ddlStudentList.SelectedValue + "','" + ddlInternshipList.SelectedValue + "')";
